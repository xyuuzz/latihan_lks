        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Form Blog Saya</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="#" id="formBlog">
                        @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button onClick="ajax($('#formBlog'), '{{isset($type) ? ($type ? "/blog/{$blog->id}" : "/blog") : "/blog"}}', '{{$type ?? "create"}}')" type="button" class="ajax btn btn-primary">Submit</button>
                </div>
            </div>
        </div>
    </div>
